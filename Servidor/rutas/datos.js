...
router.get('/post/:latitud/:longitud/:rssi/:snr/:gate/:frec', (req,res) => {
        ...
        connection.getConnection(function(error, tempConn){
                if(error){
                        ...
                        tempConn.query('INSERT INTO datos VALUES(null,?,?,?,?,?,?,null)', [lat, lon, rssi, snr, gate, frec], function(error, result){
                                if(error){
                                        throw error;
...
router.post('/', (req,res) => {
        ...
        connection.getConnection(function(error, tempConn){
                if(error){
                        ...
                        console.log('Conexion correcta');
                        tempConn.query('INSERT INTO datos VALUES(null,?,?,?,?,?,?,null)', [json1.latitud, json1.longitud, json1.rssi, json1.snr, json1.gateway, json1.frecuencia], function(error, result){
                                if(error){
                                        throw error;
                                        res.send ("error al ejecutar el query");
                                }else{
...
router.delete('/:frec/:gate', (req,res) => {
        var json1 = {};
        var arreglo=[];
        var frecb=req.params.frec;
        var gateb=req.params.gate;
